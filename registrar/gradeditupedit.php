                    ...
                    <div class="card">
                        <div class="header">
                            ...
                            <?php 
                                ...
                                $period = $res['year']; ?>
                            <small>Edit Data on Enrolment in Undergraduate Programs for School Year <?php echo $period; ?></small>
                        </div>
                        <div class="body">
                            ...
                            <?php
                                $period = $_GET['period'];
                                $eid = $_GET['id'];
                                $query1 = mysqli_query($link, "SELECT * FROM graduates WHERE id = '$eid'");
                            ...
                            ?>
                                ...
                                <div class="form-group  col-sm-12">
                                    <select class="form-control show-tick" id="du" value="<?php echo $resul['delivery_unit']; ?>"  required>
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line focused">
                                        <input type="number" class="form-control" id="telp" required value="<?php echo $resul['telp']; ?>" >
                                        <label class="form-label">Total Enrolment in the Ladderized Program</label>
                                    </div>
                                </div>
                                <div class="form-group form-float">
                                    <div class="form-line focused ">
                                        <input type="number" class="form-control" id="tety" required value="<?php echo $resul['tety']; ?>" >
                                        <label class="form-label">Total Enrolment in the Terminal Year</label>
                                    </div>
                                </div>
                                <div class="form-group form-float">
                                    <div class="form-line focused ">
                                        <input type="number" class="form-control" id="tngapril" required value="<?php echo $resul['tngapril']; ?>" >
                                        <label class="form-label">Total No. Of Graduates April <?php echo $period; ?></label>
                                    </div>
                                </div>
                                <div class="form-group form-float">
                                    <div class="form-line focused ">
                                        <input type="number" class="form-control" id="tngsummer" value="<?php echo $resul['tngsummer']; ?>" required>
                                        <label class="form-label">Total No. Of Graduates Summer <?php echo $period; ?></label>
                                    </div>
                                </div>
                                <div class="form-group form-float">
                                    <div class="form-line focused ">
                                        <input type="number" class="form-control" id="tngoct" required value="<?php echo $resul['tngoctober']; ?>">
                                        <label class="form-label">Total No. Of Graduates October <?php echo $period; ?></label>
                                    </div>
                                </div>
                                <div class="form-group form-float">
                                    <div class="form-line focused ">
                                        <input type="number" step="any" min="0" class="form-control" id="weights" value="<?php echo $resul['weights']; ?>" required>
                                        <label class="form-label">Weights</label>
                                    </div>
                                </div>
                                <input type="hidden" id="period" value="<?php echo $period; ?>">
                                <input type="hidden" id="gid" value="<?php echo $eid; ?>">
