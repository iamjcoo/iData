            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>BOARD EXAM</h2>
                            <small>Edit Data on Board Exam</small>
                        </div>
                        <div class="body">
                            <form id="add" name="add">
                                <?php
                                    $beid = $_GET['id'];
                                    $query = mysqli_query($link, "SELECT * FROM board_exam WHERE id='$beid'");
                                    $res=mysqli_fetch_assoc($query);
                                ?>
                                <div class="form-group form-float">
                                    <div class="form-line focused">
                                        <input type="text" class="form-control" id="pn" value="<?php echo $res['pn']; ?>" required>
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line focused">
                                        <input type="number" class="form-control" id="nop1ttsuc" value="<?php echo $res['nop1ttsuc']; ?>" required>
                                        <label class="form-label">No. of Passers - 1st Time Takers</label>
                                    </div>
                                </div>
                                <div class="form-group form-float">
                                    <div class="form-line focused">
                                        <input type="number" class="form-control" id="1ttsuc" value="<?php echo $res['1ttsuc']; ?>" required>
                                        <label class="form-label">1st Time Takers (SUC)</label>
                                    </div>
                                </div>
                                <div class="form-group form-float">
                                    <div class="form-line focused">
                                        <input type="number" class="form-control" id="tnpirsuc" value="<?php echo $res['tnpirsuc']; ?>" required>
                                        <label class="form-label">Total No. of Passers including Retakers</label>
                                    </div>
                                </div>
                                <div class="form-group form-float">
                                    <div class="form-line focused">
                                        <input type="number" class="form-control" id="tntirsuc" value="<?php echo $res['tntirsuc']; ?>" required>
                                        <label class="form-label">Total No. Of Takers including Retakers (SUC)</label>
                                    </div>
                                </div>
                                <div class="form-group form-float">
                                    <div class="form-line focused">
                                        <input type="number" class="form-control" id="npfttnatl" value="<?php echo $res['npfttnatl']; ?>" required>
                                        <label class="form-label">Total No. Of First Time Takers (Nat'l)</label>
                                    </div>
                                </div>
                                <div class="form-group form-float">
                                    <div class="form-line focused">
                                        <input type="number" class="form-control" id="1ttnatl" value="<?php echo $res['1ttnatl']; ?>" required>
                                        <label class="form-label">1st Time Takers (Nat'l)</label>
                                    </div>
                                </div>
                                <div class="form-group form-float">
                                    <div class="form-line focused">
                                        <input type="number" class="form-control" id="tnpirnatl" value="<?php echo $res['tnpirnatl']; ?>" required>
                                        <label class="form-label">Total No. of Passers including Retakers (Nat'l)</label>
                                    </div>
                                </div>
                                <div class="form-group form-float">
                                    <div class="form-line focused">
                                        <input type="number" class="form-control" id="tntirnatl" value="<?php echo $res['tntirnatl']; ?>" required>
                                        <label class="form-label">Total No. of Takers including Retakers (Nat'l)</label>
                                    </div>
                                </div>
                                <input type="hidden" value="<?php echo $beid; ?>" id="id">
