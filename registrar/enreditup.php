                                ...
                                <tbody>
                                    ...
                                    <?php
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $re['head_count']; ?></td>
                                                <td><?php echo $re['total_enr_units']; ?></td>
                                                <td><?php echo $re['weights']; ?></td>
                                                <td><?php echo $weu = $re['total_enr_units'] * $re['weights']; ?></td>
                                                <td><?php $fte = $weu / 18; echo round($fte, 2, PHP_ROUND_HALF_UP); ?></td>
                                                <th><a href="enreditupedit.php?period=<?php echo $period; ?>&id=<?php echo $re['id']; ?>"><button type="button"  class="btn bg-teal btn-sm waves-effect"><i class="material-icons">create</i></button></a>&nbsp;<button type="button" value="<?php echo $re['id']; ?>"" class="delete btn bg-red btn-sm waves-effect"><i class="material-icons">delete</i></button> </th>
                                            </tr>
                                            <?php
                                            }
                                        }
