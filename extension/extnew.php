                            ...
                            <form id="add" name="add">
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line focused">
                                        <input type="date" class="form-control" id="sd" required>
                                        <label class="form-label">Start Date</label>
                                    </div>
                                </div>
                                <div class="form-group form-float">
                                    <div class="form-line focused">
                                        <input type="date" class="form-control" id="ed" required>
                                        <label class="form-label">End Date</label>
                                    </div>
                                </div>
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="number" step="any" min="0" class="form-control" id="npt" required>
                                        <label class="form-label">No. of persons trained / served</label>
                                    </div>
                                </div>
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="number" step="any" min="0" class="form-control" id="tnh" required>
