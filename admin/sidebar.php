        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
                ...
                <div class="info-container">
                    <?php
                        $uname = $_SESSION['idataadmin'];
                        $query = mysqli_query($link, "SELECT * FROM user WHERE username ='$uname'");
                        $res2 = mysqli_fetch_assoc($query);
                    ?>
                    <div class="name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><?php echo $res2['username'];?></div>
                ...
                <ul class="list">
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                                ...
                                ?>
                                    <li>
                                        <a href="dm.php?period=<?php echo $res['id']; ?>" class=" waves-effect waves-block"><?php echo $res['year']; ?></a>
                                    </li>
                                <?php } ?>
                                </ul>
                    </li>
