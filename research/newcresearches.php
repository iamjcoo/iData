                    ...
                    <div class="card">
                        <div class="header">
                            <h2>
                                ...
                                <small>Add new completed researches</small>
                            </h2>
                        </div>
                        <div class="body">
                            <form id="add" name="add">
                                <div class="row clearfix">
                                    <div class="col-sm-12">
                                        <select class="form-control show-tick" id="researcher" required>
                                            <option value="">Researcher</option>
                                            <?php 
                                                $query = mysqli_query($link, "SELECT * FROM researcher");
                                                while($res=mysqli_fetch_array($query)){

                                            ?>
                                            <option value="<?php echo $res['id']; ?>"><?php echo $res['researcher']; ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                    <div class="col-sm-12">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="text" id="cresearch" class="form-control" required>
                                                <label class="form-label">Completed Researches</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
