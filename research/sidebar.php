            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li>
                                <a href="rpnew.php" class="waves-effect waves-block">Add New Data on Research Presentation</a>
                            </li>
                            <li>
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li>
                                <a href="pubnew.php" class="waves-effect waves-block">Add New Data on Research Publication</a>
                            </li>
                            <li>
                                <a href="javascript:void(0);" class="menu-toggle waves-effect waves-block">Edit Program & Data</a>
                                <ul class="ml-menu">
                    ...
                    <li>
                        <a href="javascript:void(0);" class="menu-toggle waves-effect waves-block">
                            ...
                            <span>Research with Track Records</span>
                        </a>
                        <ul class="ml-menu">
                            <li>
                                <a href="newresearcher.php" class="waves-effect waves-block">Add New Researcher</a>
                            </li>
                            <li>
                                <a href="newcresearches.php" class="waves-effect waves-block">Add Completed Researches</a>
                            </li>
                            <li>
                                <a href="neworesearches.php" class="waves-effect waves-block">Add On-Going Researches</a>
                            </li>
                            <li>
                                <a href="javascript:void(0);" class="menu-toggle waves-effect waves-block">Edit Program & Data</a>
                                <ul class="ml-menu">
