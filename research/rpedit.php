                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <?php
                                $period = $_GET['period'];
                                $eid = $_GET['id'];
                                $query1 = mysqli_query($link, "SELECT * FROM r_present WHERE id = '$eid'");
                            ...
                            <form id="add" name="add">
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line focused">
                                        <input type="date" value="<?php echo $resul['date_presented']; ?>" class="form-control" id="dp" required>
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line focused">
                                        <input type="text" value="<?php echo $resul['venue']; ?>" class="form-control" id="vcf" required>
                                        <label class="form-label">Venue of the Conference/Forum</label>
                                    </div>
                                </div>
                                <div class="form-group form-float">
                                    <div class="form-line focused">
                                        <input type="text" value="<?php echo $resul['f_title']; ?>" class="form-control" id="tocf" required>
                                        <label class="form-label">Title of the Conference/Forum</label>
                                    </div>
                                </div>
                                <div class="form-group form-float">
                                    <div class="form-line focused">
                                        <input type="text" value="<?php echo $resul['authors']; ?>" class="form-control" id="na" required>
