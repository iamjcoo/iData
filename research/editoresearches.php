            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                ON-GOING RESEARCH
                                <small>Edit on-going Research of <?php 
                        ...
                        <div class="body">
                            <form id="add" name="add">
                                <div class="row clearfix">
                                    <?php
                                        $reid = $_GET['id'];
                                        $query1 = mysqli_query($link, "SELECT * FROM oresearch WHERE id = '$reid'");
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group form-float">
                                            <div class="form-line focused">
                                                ...
                                                <label class="form-label">On-going Research</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
