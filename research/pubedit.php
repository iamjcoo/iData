...
<body class="theme-blue">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            ...
                            <small>Edit Data on Research Presentation</small>
                        </div>
                        <div class="body">
                            <?php
                                $period = $_GET['period'];
                                $eid = $_GET['id'];
                                $query1 = mysqli_query($link, "SELECT * FROM r_publish WHERE id = '$eid'");
                            ...
                            <form id="add" name="add">
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line focused">
                                        <input value="<?php echo $resul['title']; ?>" type="text" class="form-control" id="rt" required>
                                        <label class="form-label">Research Title</label>
                                    </div>
                                </div>
                                <div class="form-group form-float">
                                    <div class="form-line focused">
                                        <input value="<?php echo $resul['p_duration']; ?>" type="number" class="form-control" id="psd" required>
                                        <label class="form-label">Project/Study Duration (in terms of mos)</label>
                                    </div>
                                </div>
                                <div class="form-group form-float">
                                    <div class="form-line focused">
                                        <input type="date" value="<?php echo $resul['date_started']; ?>" class="form-control" id="mys" required>
                                        <label class="form-label">Mo. & Year Started</label>
                                    </div>
                                </div>
                                <div class="form-group form-float">
                                    <div class="form-line focused">
                                        <input type="date" value="<?php echo $resul['date_completed']; ?>" class="form-control date" id="myc" required>
                                        <label class="form-label date">Mo. & Year Completed</label>
                                    </div>
                                </div>
                                <div class="form-group form-float">
                                    <div class="form-line focused">
                                        <input type="date" value="<?php echo $resul['date_published']; ?>" class="form-control" id="dp" required>
                                        <label class="form-label">Date Published</label>
                                    </div>
                                </div>
                                <div class="form-group form-float">
                                    <div class="form-line focused">
                                        <input type="text" value="<?php echo $resul['jp_type']; ?>" class="form-control" id="tcf" required>
                                        <label class="form-label">Type of Journal/Publication</label>
                                    </div>
                                </div>
                                <div class="form-group form-float">
                                    <div class="form-line focused">
                                        <input type="text" value="<?php echo $resul['pname']; ?>" class="form-control" id="vcf" required>
                                        <label class="form-label">Name of Publication</label>
                                    </div>
                                </div>
                                <div class="form-group form-float">
                                    <div class="form-line focused">
                                        <input type="text" value="<?php echo $resul['vol']; ?>" class="form-control" id="tocf" required>
                                        <label class="form-label">Vol. No.</label>
                                    </div>
                                </div>
                                <div class="form-group form-float">
                                    <div class="form-line focused">
                                        <input type="text" value="<?php echo $resul['author']; ?>" class="form-control" id="na" required>
                                        <label class="form-label">Name of Author/s</label>
                                    </div>
                                </div>
                                <input type="hidden" id="rid" value="<?php echo $eid; ?>">
    ...
    $(document).ready(function() {
        ...
        var na = $("#na").val();
        var rid = $("#rid").val();
        if (du == '' || tr == '' ||  rt == '' || psd == '' || mys == '' || myc == '' || dp == '' || tcf == '' || vcf == '' || tocf == '' || na == '' || rid == '') {
         $.notify({
            // options
