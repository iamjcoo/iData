        ...
        <div class="container-fluid">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                ON-GOING RESEARCHES <?php echo $_GET['period']; ?>
                            </h2>
                        </div>
                        <div class="body table-responsive">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="editoresearches.php?id=<?php echo $res3['id']; ?>&author=<?php echo $res['id']; ?>"><button type="button"  class="btn bg-teal btn-sm waves-effect"><i class="material-icons">create</i></button></a>&nbsp;<button type="button" value="<?php echo $res3['id']; ?>"" class="delete btn bg-red btn-sm waves-effect"><i class="material-icons">delete</i></button> </td>
                                <tr>
                                <?php } } ?>
                            </tbody>
                            </table>
